...
public class DaoImpl implements Dao {
    ...
    public Connection getConnection() throws SQLException {
        ...
        if (!Trans.isTransactionNone()) {
            mvcTransaction tn = (mvcTransaction) Trans.get();
