...
import com.aude.mvc.aop.proxy.ProxyClassFiter;
import com.aude.mvc.trans.TransAop;
import com.aude.mvc.util.Logs;
import com.aude.mvc.util.StringsTool;
import com.google.gson.Gson;
import com.aude.mvc.annotation.Aop;
import com.aude.mvc.aop.ProxyFactory;
...
import com.aude.mvc.trans.TransactionProxy;
        ...
        try {
            ...
            if (beanKey.startsWith("java:")) {
                ...
                if (klazz == String.class) {
                    ...
                    logger.error(String.format("%s此类型暂未处理,请至%s提交", klazz, Constant.mvc_AUTHOR_ISSUES));
                }
            } else {
